...
![Likelihood of Skills Requested in Job Postings](images/SkillLikelihood.png)
...
*A scatter plot visualizing the most optimal skills (high paying & high demand) for data analysts with color labels for technology.*
